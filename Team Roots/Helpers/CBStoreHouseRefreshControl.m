                          ...
                          internalAnimationFactor:(CGFloat)internalAnimationFactor
{
    ...
    for (int i=0; i<startPoints.count; i++) {
        ...
        BarItem *barItem = [[BarItem alloc] initWithFrame:refreshControl.frame startPoint:startPoint endPoint:endPoint color:[UIColor lightGrayColor] lineWidth:lineWidth];
        barItem.tag = i;
